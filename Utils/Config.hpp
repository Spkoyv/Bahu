...
bool PredictBulletDrop = false;
float Speed = 12;
float Smooth = 0.8;
float HipfireSmooth = 0.8;
float ADSSmooth = 0.9;
float SmoothDistance = 10000;
float Deadzone = 0.5;
int Delay = 12;
float FOV = 5;
float ZoomScale = 2.5;
float MinDistance = 1;
float HipfireDistance = 45;
...
float RE45Pitch = 6.5;
float RE45Yaw = 3.5;
float AlternatorPitch = 6;
float AlternatorYaw = 3.5;
float R99Pitch = 6;
float R99Yaw = 4;
float R301Pitch = 5;
float R301Yaw = 4;
float SpitfirePitch = 5;
float SpitfireYaw = 5;
float G7Pitch = 4;
float G7Yaw = 2.5;
//Heavy
float FlatlinePitch = 4;
float FlatlineYaw = 5.5;
float HemlockPitch = 1.5;
float HemlockYaw = 5;
float RepeaterPitch = 3.5;
float RepeaterYaw = 2;
float RampagePitch = 6;
float RampageYaw = 5;
float CARSMGPitch = 5;
float CARSMGYaw = 6;
//Energy
float HavocPitch = 5.5;
float HavocYaw = 4;
float DevotionPitch = 4.4;
float DevotionYaw = 6.5;
float LSTARPitch = 3;
float LSTARYaw = 4.5;
float TripleTakePitch = 1;
float TripleTakeYaw = 1;
float VoltPitch = 3;
float VoltYaw = 2.5;
float NemesisPitch = 3;
float NemesisYaw = 2.5;
//Shotguns
float MozambiquePitch = 10;
float MozambiqueYaw = 10;
float EVA8Pitch = 1;
float EVA8Yaw = 1;
float PeacekeeperPitch = 1;
float PeacekeeperYaw = 1;
float MastiffPitch = 1;
float MastiffYaw = 1;
//Snipers
float LongbowPitch = 1;
float LongbowYaw = 1;
float ChargeRiflePitch = 1;
float ChargeRifleYaw = 1;
float SentinelPitch = 1;
float SentinelYaw = 1;
//Legendary
...
int GlowRadius = 45;
int InsideFunction = 134; //Leave
int OutlineFunction = 6; //Leave
int BodyStyle = 20;
int OutlineStyle = 1;
bool ItemGlow = true;
//Colors
...
int BoxType = 0;
int BoxStyle = 0;
float BoxThickness = 2.0;

bool Skeleton = true;
float SkeletonThickness = 2.0;
