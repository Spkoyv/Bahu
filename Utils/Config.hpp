...
float AdvancedSmooth = 0.69;
float AdvancedHipfireSmooth = 0.69;
float AdvancedADSSmooth = 0.69;
...
float P2020Hitbox = 2;
float P2020Speed = 18;
float P2020HipfireSmooth = 0.69;
float P2020ADSSmooth = 0.69;
bool RE45ClosestHitbox = true;
float RE45Hitbox = 2;
float RE45Speed = 0.99;
float RE45HipfireSmooth = 10;
float RE45ADSSmooth = 0.69;
bool AlternatorClosestHitbox = true;
float AlternatorHitbox = 2;
float AlternatorSpeed = 18;
float AlternatorHipfireSmooth = 0.69;
float AlternatorADSSmooth = 0.69;
bool R99ClosestHitbox = true;
float R99Hitbox = 2;
float R99Speed = 18;
float R99HipfireSmooth = 0.69;
float R99ADSSmooth = 0.69;
bool R301ClosestHitbox = true;
float R301Hitbox = 2;
float R301Speed = 18;
float R301HipfireSmooth = 0.69;
float R301ADSSmooth = 0.69;
bool SpitfireClosestHitbox = true;
float SpitfireHitbox = 2;
float SpitfireSpeed = 18;
float SpitfireHipfireSmooth = 0.69;
float SpitfireADSSmooth = 0.69;
bool G7ClosestHitbox = true;
float G7Hitbox = 2;
float G7Speed = 18;
float G7HipfireSmooth = 0.69;
float G7ADSSmooth = 0.69;
//Heavy
bool FlatlineClosestHitbox = true;
float FlatlineHitbox = 2;
float FlatlineSpeed = 18;
float FlatlineHipfireSmooth = 0.69;
float FlatlineADSSmooth = 0.69;
bool HemlockClosestHitbox = true;
float HemlockHitbox = 2;
float HemlockSpeed = 18;
float HemlockHipfireSmooth = 0.69;
float HemlockADSSmooth = 0.69;
bool RepeaterClosestHitbox = true;
float RepeaterHitbox = 2;
float RepeaterSpeed = 18;
float RepeaterHipfireSmooth = 0.69;
float RepeaterADSSmooth = 0.69;
bool RampageClosestHitbox = true;
float RampageHitbox = 2;
float RampageSpeed = 18;
float RampageHipfireSmooth = 0.69;
float RampageADSSmooth = 0.69;
bool CARSMGClosestHitbox = true;
float CARSMGHitbox = 2;
float CARSMGSpeed = 18;
float CARSMGHipfireSmooth = 0.69;
float CARSMGADSSmooth = 0.69;
//Energy
bool HavocClosestHitbox = true;
float HavocHitbox = 2;
float HavocSpeed = 18;
float HavocHipfireSmooth = 0.69;
float HavocADSSmooth = 0.69;
bool DevotionClosestHitbox = true;
float DevotionHitbox = 2;
float DevotionSpeed = 18;
float DevotionHipfireSmooth = 0.69;
float DevotionADSSmooth = 0.69;
bool LSTARClosestHitbox = true;
float LSTARHitbox = 2;
float LSTARSpeed = 18;
float LSTARHipfireSmooth = 0.69;
float LSTARADSSmooth = 0.69;
bool TripleTakeClosestHitbox = true;
float TripleTakeHitbox = 2;
float TripleTakeSpeed = 18;
float TripleTakeHipfireSmooth = 0.69;
float TripleTakeADSSmooth = 0.69;
bool VoltClosestHitbox = true;
float VoltHitbox = 2;
float VoltSpeed = 18;
float VoltHipfireSmooth = 0.69;
float VoltADSSmooth = 0.69;
bool NemesisClosestHitbox = true;
float NemesisHitbox = 2;
float NemesisSpeed = 18;
float NemesisHipfireSmooth = 0.69;
float NemesisADSSmooth = 0.69;
//Shotguns
bool MozambiqueClosestHitbox = true;
float MozambiqueHitbox = 2;
float MozambiqueSpeed = 18;
float MozambiqueHipfireSmooth = 0.69;
float MozambiqueADSSmooth = 0.69;
bool EVA8ClosestHitbox = true;
float EVA8Hitbox = 2;
float EVA8Speed = 18;
float EVA8HipfireSmooth = 0.69;
float EVA8ADSSmooth = 0.69;
bool PeacekeeperClosestHitbox = true;
float PeacekeeperHitbox = 2;
float PeacekeeperSpeed = 18;
float PeacekeeperHipfireSmooth = 0.69;
float PeacekeeperADSSmooth = 0.69;
bool MastiffClosestHitbox = true;
float MastiffHitbox = 2;
float MastiffSpeed = 18;
float MastiffHipfireSmooth = 0.69;
float MastiffADSSmooth = 0.69;
//Snipers
bool LongbowClosestHitbox = true;
float LongbowHitbox = 2;
float LongbowSpeed = 18;
float LongbowHipfireSmooth = 0.69;
float LongbowADSSmooth = 0.69;
bool ChargeRifleClosestHitbox = true;
float ChargeRifleHitbox = 2;
float ChargeRifleSpeed = 18;
float ChargeRifleHipfireSmooth = 0.69;
float ChargeRifleADSSmooth = 0.69;
bool SentinelClosestHitbox = true;
float SentinelHitbox = 2;
float SentinelSpeed = 18;
float SentinelHipfireSmooth = 0.69;
float SentinelADSSmooth = 0.69;
//Legendary
bool WingmanClosestHitbox = true;
float WingmanHitbox = 2;
float WingmanSpeed = 18;
float WingmanHipfireSmooth = 0.69;
float WingmanADSSmooth = 0.69;
bool ProwlerClosestHitbox = true;
float ProwlerHitbox = 2;
float ProwlerSpeed = 18;
float ProwlerHipfireSmooth = 0.69;
float ProwlerADSSmooth = 0.69;
bool KraberClosestHitbox = true;
float KraberHitbox = 2;
float KraberSpeed = 18;
float KraberHipfireSmooth = 0.69;
float KraberADSSmooth = 0.69;
bool BocekClosestHitbox = true;
float BocekHitbox = 2;
float BocekSpeed = 18;
float BocekHipfireSmooth = 0.69;
float BocekADSSmooth = 0.69;
bool ThrowingKnifeClosestHitbox = true;
float ThrowingKnifeHitbox = 2;
float ThrowingKnifeSpeed = 18;
float ThrowingKnifeHipfireSmooth = 0.69;
float ThrowingKnifeADSSmooth = 0.69;
